...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Velkommen</strong> til an602<br>Dit Sociale Netværks værtøjskasse',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Nedenunder skal du indtaste oplysningerne for at forbinde til din database. Hvis du ikke er sikker på dette, så kontakt din system administrator.',
    ...
    'Hostname' => 'Vært',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Værtsnavn til din MySQL Database Server (e.g. localhost hvis MySQL er kørende på den samme maskine)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Installationen blev udført med succes! God fornøjelse med dit nye sociale netværk.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Navnet på databasen som du vil have HumHum til at køre i.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Denne oversigt viser alle systemkrav til an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Denne installationsguide vil installere og konfigurere din egen an602.<br><br>Tryk næste for at fortsætte.',
    'Username' => 'Brugernavn',
    ...
    'Your MySQLi password.' => 'Dit MySQL kodeord.',
    'Your MySQLi username' => 'Dit MySQL brugernavn',
