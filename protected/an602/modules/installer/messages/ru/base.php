...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Добро пожаловать</strong> в an602<br>Это Ваша социальная сеть',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Ниже Вы должны ввести свои данные для подключения к базе данных. Если Вы не уверены в них или затрудняетесь корректности, пожалуйста, обратитесь к системному администратору.',
    ...
    'Hostname' => 'Имя хоста',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Имя или адрес хоста для сервера базы данных MySQL (например, localhost, если MySQL работает на той же машине что и устанавливаемый an602)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Установка прошла успешно! Удачи в ваших начинаниях.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Имя базы данных MySQL',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Список ниже содежит все системные требования и рекомендации для an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Мастер установки настроит Ваш собственный экземпляр an602.<br><br>Чтобы продолжить, нажмите кнопку Далее.',
    ...
    'Your MySQLi password.' => 'Пароль MySQL',
    'Your MySQLi username' => 'Имя пользователя MySQL',
