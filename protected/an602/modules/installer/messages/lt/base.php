...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Sveiki atvykę </strong> į an602<br>Jūsų socialinio tinklo valdymo lauką',
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Žemiau Jūs turite atidaryti savo duomenų bazės prisijungimo informaciją. Jei nesate tikri dėl to, susisiekite su savo sistemos administratoriumi.',
    ...
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Jūsų MySQL duomenų bazės pagrindinis serveris. (pvz., vietinis kompiuteris, jei MySQL veikia tame pačiame įrenginyje)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Diegimas pavyko sėkmingai! Mėgaukitės savo naujuoju socialiniu tinklu.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Duomenų bazės, kurią norite paleisti an602, pavadinimas.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Ši apžvalga rodo visus an602 sistemos reikalavimus.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Šis pagalbininkas įdiegs ir nustatys Jūsų asmeninį an602. <br><br> Norint tęsti, spauskite čia.',
    'Username' => 'Vartotojo vardas',
    'Your MySQLi password.' => 'Jūsų MySQL slaptažodis.',
    'Your MySQLi username' => 'Jūsų MySQ vartotojo vardas',
