...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>an602</strong>\'a hoşgeldiniz<br />Sosyal Ağınız',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Veritabanı bağlantı ayarlarını girmek zorundasınız. Bu konuda emin değilseniz sistem yöneticinize başvurun.',
    ...
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'MySQL veritabanı sunucusu ana bilgisayar adı (örneğin, localhost MySQL aynı makinede çalışıyorsa)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Kurulum başarıyla tamamlandı! <br /> Yeni sosyal ağınızla paylaşım yapmaya başlayabilirsiniz.',
    'The name of the database that you want to run PHP-AN602 in.' => 'an602 kurulumu için çalışmak istediğiniz veritabanı adı.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'an602 sistem gereksinimlerinizin uygun olup olmadığını gösterir.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Kurulum sihirbazı ile kendi an602 Sosyal Ağınızı oluşturabilirsiniz.<br />Devam etmek için İleri\'ye tıklayın.',
    ...
    'Your MySQLi password.' => 'MySQL şifre',
    'Your MySQLi username' => 'MySQL kullanıcı adı',
