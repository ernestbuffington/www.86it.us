...
return array (
  ...
  '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Bienvenue</strong> sur an602<br>Votre réseau social',
  ...
  'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Vous devez préciser ci-dessous les détails de la connexion à votre base de données. Si vous n\'êtes pas certain de ceux-ci, merci de contacter votre administrateur système.',
  ...
  'Hostname' => 'Nom d\'hôte',
  'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Nom du serveur de base de données MySQL (ex : localhost si MySQL fonctionne sur la même machine)',
  ...
  'In order to activate this feature, it is necessary to edit the PHP-AN602 configuration and, potentially, the configuration of the WebServer.' => 'Pour activer cette fonction, il faut modifier la configuration de an602 et éventuellement celle du serveur web.',
  ...
  'The installation has completed successfully! Enjoy your new 86it network node.' => 'L\'installation s\'est terminée avec succès ! Amusez-vous bien avec votre nouveau réseau social.',
  'The name of the database that you want to run PHP-AN602 in.' => 'Le nom de la base de données dans laquelle an602 va fonctionner.',
  'This overview shows all of the system requirements for PHP-AN602.' => 'Cet aperçu affiche tous les prérequis système de an602.',
  ...
  'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Cet assistant va installer et configurer votre propre instance de an602.<br><br>Pour continuer, cliquez sur Suivant.',
  ...
  'Your MySQLi password.' => 'Votre mot de passe MySQL',
  'Your MySQLi username' => 'Votre nom d\'utilisateur MySQL',
