...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Benvenuto</strong> su an602<br> Il tuo  Social Network Toolbox',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Qui sotto devi inserire i dettagli per la connessione al database. Se non sei sicuro di avere questi dati, contatta l\'amministratore di sistema.',
    ...
    'Hostname' => 'Hostname',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Hostname del tuo MySQL Database Server (es. localhost se MySQL è attivo nella stessa macchina)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'L\'installazione è completata! Buon divertimento con il tuo nuovo social network.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Il nome della database in cui vuoi installare an602.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Riepilogo di tutti i requisiti di sistema per an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Questa procedura guidata installa e configura la tua istanza an602. <br><br> Per continuare, clicca su Avanti.',
    ...
    'Your MySQLi password.' => 'La tua passowrd MySQL.',
    'Your MySQLi username' => 'Il tuo username MySQL',
