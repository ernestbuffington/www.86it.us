...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>欢迎来到</strong> an602<br>你的社交网络工具箱！',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => '下面你必须输入数据库连接的详细信息。如果你不确定，请与系统管理员联系',
    ...
    'Hostname' => '主机名',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'MySQL数据库服务器的主机名（例如:如果MySQL是同一台机器上运行,输入localhost）',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => '安装成功完成！祝你在新社交平台上玩得开心。',
    'The name of the database that you want to run PHP-AN602 in.' => '你想要存an602数据的数据库名',
    'This overview shows all of the system requirements for PHP-AN602.' => '以下展示了an602的所有系统需求',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => '该向导将安装和配置你自己的an602实例.<br><br>点击下一步继续。',
    'To avoid a blank dashboard after your initial login, PHP-AN602 can install example contents for you. Those will give you a nice general view of how PHP-AN602 works. You can always delete the individual contents.' => '为了避免初始登录后空白的仪表板，an602可以安装一些示例内容。这将给你一个很好an602概览。您可以随时删除示例内容。',
    ...
    'Your MySQLi password.' => '数据库存密码。',
    'Your MySQLi username' => '数据库用户名',
