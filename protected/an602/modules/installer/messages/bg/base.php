...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Добре дошли</strong> в an602 <br>Кутията с инструменти за Вашата Социална Мрежа',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'По-долу трябва да въведете данните за връзката на вашата база от данни. Ако не сте сигурни за това, моля, свържете се със системния ви администратор.',
    ...
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Име на хост на вашия сървър за база от данни MySQL (напр. localhost, ако MySQL работи на същата машина)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Инсталацията завърши успешно! Забавлявайте се с новата си социална мрежа.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Името на базата от данни, в която искате да стартирате an602.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Този общ преглед показва всички системни изисквания на an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Този съветник ще инсталира и конфигурира вашата собствена инстанция на an602.<br><br>За да продължите, щракнете върху Напред.',
    ...
    'Your MySQLi password.' => 'Вашата парола за MySQL.',
    'Your MySQLi username' => 'Вашето потребителско име за MySQL',
