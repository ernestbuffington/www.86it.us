...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Velkommen</strong> til an602<br>Ditt sosiale nettverk!',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Nedenfor fyller du inn databasedetaljene. Hvis du ikke er sikker på denne informasjonen, vennligst kontakt din systemadministrator.',
    ...
    'Hostname' => 'Host',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Hostnavn for din MySQL-server (localhost hvis denne kjører på samme maskin)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Installasjonen er vellykket. Ha det gøy med ditt nye sosiale nettverk!',
    'The name of the database that you want to run PHP-AN602 in.' => 'Navnet på databasen',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Denne oversikten viser deg systemkravene for an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Denne veiviseren vil installere og tilpasse din an602 installasjon.<br><br>Trykk neste for å fortsette.',
    ...
    'Your MySQLi password.' => 'Ditt MySQL passord',
    'Your MySQLi username' => 'Ditt MySQL brukernavn',
