...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Witaj</strong> w an602<br>Szwajcarskim scyzoryku Twojej Sieci Społecznościowej',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Wprowadź szczegóły połączenia z bazą danych. Jeśli nie masz co do nich pewności, skontaktuj się z administratorem Twojego serwera.',
    ...
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Nazwa hosta dla twojego serwera MySQL. (np. localhost jeśli MySQL działa na tej samej maszynie)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Instalacja zakończona sukcesem! Dobrej zabawy z nową siecią społecznościową.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Nazwa bazy danych dla an602',
    'This overview shows all of the system requirements for PHP-AN602.' => 'To podsumowanie prezentuje wszystkie wymagania systemowe an602.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Ten kreator pomoże Ci skonfigurować własną instalację an602.<br><br> Aby kontynuować naciśnij "Dalej".',
    ...
    'Your MySQLi password.' => 'Hasło MySQL',
    'Your MySQLi username' => 'użytkownik MySQL',
