...
return array (
  ...
  '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>歡迎</strong>來到an602<br>您的社群網路工具箱',
  ...
  'Hostname' => 'Hostname',
  'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => '您的MySQL資料庫伺服器Hostname (例如: localhost 如果您的MySQL運作在相同的主機上)',
  ...
  'The installation has completed successfully! Enjoy your new 86it network node.' => '安裝過程已經完全成功! 開心使用您全新的社群網路吧。',
  'The name of the database that you want to run PHP-AN602 in.' => '您打算用來安裝an602的資料庫名稱。',
  ...
  'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => '這個安裝精靈將會帶領您安裝和設定您自己的an602網站<br><br>要繼續操作，請點選下一步。',
  ...
  'Your MySQLi password.' => '您的 MySQL 密碼',
  'Your MySQLi username' => '您的 MySQL 用戶名',
