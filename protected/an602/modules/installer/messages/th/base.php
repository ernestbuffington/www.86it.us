...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>ยินดีต้อนรับ</strong> สู่ an602<br>กล่องเครื่องมือเครือข่ายสังคมของคุณ',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'ด้านล่างคุณต้องป้อนรายละเอียดการเชื่อมต่อฐานข้อมูลของคุณ หากคุณไม่แน่ใจเกี่ยวกับสิ่งเหล่านี้ โปรดติดต่อผู้ดูแลระบบของคุณ',
    ...
    'Hostname' => 'ชื่อโฮสต์',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'ชื่อโฮสต์ของเซิร์ฟเวอร์ฐานข้อมูล MySQL ของคุณ (เช่น localhost หาก MySQL ทำงานบนเครื่องเดียวกัน)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'การติดตั้งเสร็จสมบูรณ์! ขอให้สนุกกับเครือข่ายสังคมใหม่ของคุณ',
    'The name of the database that you want to run PHP-AN602 in.' => 'ชื่อของฐานข้อมูลที่คุณต้องการเรียกใช้ an602',
    'This overview shows all of the system requirements for PHP-AN602.' => 'ภาพรวมนี้แสดงความต้องการของระบบทั้งหมดของ HumHu',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'วิซาร์ดนี้จะติดตั้งและกำหนดค่าอินสแตนซ์ an602 ของคุณเอง<br><br>หากต้องการดำเนินการต่อ ให้คลิกถัดไป',
    ...
    'Your MySQLi password.' => 'รหัสผ่าน MySQL ของคุณ',
    'Your MySQLi username' => 'ชื่อผู้ใช้ MySQL ของคุณ',
