...
return [
    ...
    '<strong>Welcome</strong> to PHP-AN602<br>Your 86it Developers Network Toolbox' => '<strong>Vítejte</strong> v síti an602',
    ...
    'Below you must enter your database connection details. If you’re not sure about these, please contact your system administrator.' => 'Níže prosím zadejte vaše údaje pro připojení k databázi. Jestliže si jimi nejste jisti, obraťte se na správce vašeho serveru.',
    ...
    'Hostname' => 'Hostname',
    'Hostname of your MySQLi Database Server (e.g. localhost if MySQLi is running on the same machine)' => 'Hostname vašeho MySQL serveru (např. localhost, běží-li MySQL na stejném serveru)',
    ...
    'The installation has completed successfully! Enjoy your new 86it network node.' => 'Instalace byla úspěšná! Přejeme, ať vám síť dobře slouží.',
    'The name of the database that you want to run PHP-AN602 in.' => 'Jméno databáze, do které chcete an602 nainstalovat.',
    'This overview shows all of the system requirements for PHP-AN602.' => 'Tento přehled ukazuje všechny požadavky an602u.',
    'This wizard will install and configure your PHP-AN602 network node.<br><br>To continue, click Next.' => 'Tento průvodce vám pomůže nainstalovat a nastavit síť an602.<br><br>Chcete-li pokračovat, klikněte na tlačítko Další.',
    ...
    'Your MySQLi password.' => 'Heslo pro přístup k databázi',
    'Your MySQLi username' => 'Uživatelské jméno pro přístup k databázi',
