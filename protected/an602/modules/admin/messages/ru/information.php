...
return [
    ...
    'PHP-AN602 is currently in debug mode. Disable it when running on production!' => 'an602 в данный момент находится в режиме отладки. Отключите его при работе на действующем проекте!',
    'Info' => 'Информация',
